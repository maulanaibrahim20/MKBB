                ...
                <div class="col-lg-8">
                    ...
                    @forelse ($blogs as $blog)
                        <div class="position-relative mb-3">
                            <img class="img-fluid w-100" src="{{ asset('storage/' . $blog->gambar) }}"
                                style="object-fit: cover;">
                            <div class="bg-white border border-top-0 p-4">
                                <h1 class="mb-3 text-secondary text-uppercase font-weight-bold">{{ $blog->judul }}</h1>
                                <p>{{ $blog->deskripsi }}</p>
                            </div>
                        </div>
                    @empty
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white text-center border border-top-0 p-3">
                            <a href=""><img class="img-fluid" src="images/1.jpg" alt=""></a>
                        </div>
                    </div>
                    <!-- Ads End -->
                    ...
                    <div class="mb-3">
                        <div class="section-title mb-0">
                            <h4 class="m-0 text-uppercase font-weight-bold">Berita Terpopuler</h4>
                        </div>
                        <div class="bg-white border border-top-0 p-3">
                            <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                <img class="img-fluid" src="images/9.jpg" alt=""
                                    style="width: 110px; object-fit: cover;">
                                <div
