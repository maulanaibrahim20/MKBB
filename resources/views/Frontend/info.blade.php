...
@section('content')
    ...
    <div class="container my-4">
        <ul class="nav nav-tabs justify-content-center" id="profileTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link text-dark" id="notif-tab" data-bs-toggle="tab" data-bs-target="#notif"
                    type="button" role="tab" aria-controls="notif" aria-selected="false">Selesai</button>
            </li>
        </ul>
